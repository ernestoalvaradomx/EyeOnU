...
if __name__ == "__main__":
    ...
    if args.ii:
        ImageIdentificationDeamon(interval=5, app=app, rawFrameService=frameService, video_feed_url=video_feed_url) # Carga deamon cada 30 segundos
        logger.info("Active ImageIdentificationDeamon")
    ReincidentAlertDeamon(interval=1, app=app, socketio=socketio)
